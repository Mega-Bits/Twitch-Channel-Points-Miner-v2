...
from .catalogless_game_drop_state_patch import apply_patch as _apply_catalogless_game_drop_state_patch
...
_apply_catalogless_game_drop_state_patch()
...
del _apply_catalogless_game_drop_state_patch
